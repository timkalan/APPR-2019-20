...
Spodnji zemljevid prikazuje emigracijo iz svetovnih držav v zadnjih petdesetih letih.

```{r zemljevid, echo=FALSE, fig.align='center', fig.cap='Zemljevid izseljevanja iz držav'}
